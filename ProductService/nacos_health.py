...
class NacosHeartbeatManager:
    ...
    def _init_nacos_client(self):
        ...
        try:
            ...
            logger.info(f"💓 Nacos heartbeat client initialized: {nacos_server}")
    ...
    def send_heartbeat(self):
        ...
        try:
            ...
            logger.debug(f"💓 Heartbeat sent: {self.service_name}@{self.service_ip}:{self.service_port}")
            return True
        except Exception as e:
    ...
    def start_heartbeat(self):
        ...
        logger.info(f"💓 Nacos heartbeat started (interval: {self.heartbeat_interval}s)")
